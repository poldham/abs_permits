---
title: "Unique Identifiers in an Online Permit and Monitoring System"
author: "Paul Oldham"
date: "24 May 2016"
...
This section discusses the use of unique identifiers for permits and related documents and the application of the principle of triple redundancy.  
...
Unique identifiers linked to a permit and corresponding MAT (an ABS contract) are also the key to monitoring the outcomes of research including the genetic resources. We propose a system consisting of the following unique identifiers
...
More information from the URL can then be accessed in R or through the BOLD website. On the BOLD website this produces a list of sequence related records. The image below is viewable [here](http://boldsystems.org/index.php/Taxbrowser_Taxonpage?taxid=191949)
