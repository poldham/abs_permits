...
c) Research type added. This refers to whether research is commercial or non commercial based on applicant answer to questions in applicatio forms _and_ to use of lookup table for key terms to be generated from literature and patent data as a flag in UI)
